...
class BranchDetailsAdapter(private val branch: Branch): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
  ...
  override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
    when(holder) {
      is BranchDetailsAdapter.BranchHeaderHolder -> holder.bind()
      is BranchDetailsAdapter.BranchDetailsHolder -> holder.bind()
    }
  }
